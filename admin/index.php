        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $published_count = mysqli_num_rows($published_post);
                    
                    $query = "SELECT * FROM comments WHERE comment_status = 'unapproved'";
                    $unapprove_comments = mysqli_query($connection, $query);
                    $unapprove_count = mysqli_num_rows($unapprove_comments);
                    
                    $query = "SELECT * FROM users WHERE user_role = 'subscriber'";
                    $select_all_subscribers = mysqli_query($connection, $query);
                    $count_subscriber = mysqli_num_rows($select_all_subscribers);
                ?>
                <div class="row">
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                              ['Data', 'Count'],
                              <?php 
                                $elements_text = ['All Posts','Active Posts', 'Draft Post', 'Comments', 'Pending Comments','Users', 'Subscirber','Categories'];
                                $element_count = [$post_counts,$published_count, $post_draft_count, $count_comments, $unapprove_count, $count_users, $count_subscriber, $count_categories];
                                for($i=0; $i < 8; $i++) {
